    ...
    with _lock:
        ...
        defaults = {
            ...
            "bot_registry"         : json.dumps([
                {"id": "bot1_dice",     "enabled": True, "display_name": "bot1_dice",     "platform": "stake", "strategy": "dice"},
                {"id": "bot2_limbo",    "enabled": True, "display_name": "bot2_limbo",    "platform": "stake", "strategy": "limbo"},
                {"id": "bot3_mines",    "enabled": True, "display_name": "bot3_mines",    "platform": "stake", "strategy": "mines"},
                {"id": "bot4_poly",     "enabled": True, "display_name": "bot4_poly",     "platform": "poly",  "strategy": "edge_scanner"},
                {"id": "bot5_poly",     "enabled": True, "display_name": "bot5_poly",     "platform": "poly",  "strategy": "edge_scanner"},
                {"id": "bot6_poly",     "enabled": True, "display_name": "bot6_poly",     "platform": "poly",  "strategy": "edge_scanner"},
                {"id": "bot7_momentum", "enabled": True, "display_name": "bot7_momentum", "platform": "poly",  "strategy": "btc_momentum"},
                {"id": "bot8_arb",      "enabled": True, "display_name": "bot8_arb",      "platform": "poly",  "strategy": "intra_arb"},
                {"id": "bot9_sniper",   "enabled": True, "display_name": "bot9_sniper",   "platform": "poly",  "strategy": "resolution_sniper"},
                {"id": "bot10_volume",  "enabled": True, "display_name": "bot10_volume",  "platform": "poly",  "strategy": "volume_spike"},
            ]),
        }
