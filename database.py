    ...
    with _lock:
        ...
        defaults = {
            ...
            "bot_registry"         : json.dumps([
                {"id": "bot1_dice",     "enabled": True, "display_name": "RIZZ",     "platform": "stake", "strategy": "dice"},
                {"id": "bot2_limbo",    "enabled": True, "display_name": "GHOST",    "platform": "stake", "strategy": "limbo"},
                {"id": "bot3_mines",    "enabled": True, "display_name": "KABOOM",   "platform": "stake", "strategy": "mines"},
                {"id": "bot4_poly",     "enabled": True, "display_name": "ORACLE",   "platform": "poly",  "strategy": "edge_scanner"},
                {"id": "bot5_poly",     "enabled": True, "display_name": "PROPHET",  "platform": "poly",  "strategy": "edge_scanner"},
                {"id": "bot6_poly",     "enabled": True, "display_name": "VISION",   "platform": "poly",  "strategy": "edge_scanner"},
                {"id": "bot7_momentum", "enabled": True, "display_name": "SATURN",   "platform": "poly",  "strategy": "btc_momentum"},
                {"id": "bot8_arb",      "enabled": True, "display_name": "GLITCH",   "platform": "poly",  "strategy": "intra_arb"},
                {"id": "bot9_sniper",   "enabled": True, "display_name": "HAWKEYE",  "platform": "poly",  "strategy": "resolution_sniper"},
                {"id": "bot10_volume",  "enabled": True, "display_name": "SURGE",    "platform": "poly",  "strategy": "volume_spike"},
            ]),
        }
